...
// 🔴 Coaching Reference (item 4.9) REMOVED 2026-08-20 — item 4.24, Mike's Option D.
// The fifteen platform rows in data/coaching-reference.json were measured against the
// logic trees that superseded them, the seven pieces worth keeping were folded into
// those trees, and the block, its cascade and its tab were removed on his instruction
// ("remove the tab", 2026-08-20). The seven routes and their handlers went with it.
//
// 🔴 UNTOUCHED: a firm's PROMOTED CASE OBSERVATIONS, under config_key
// `coaching-reference`. Different mechanism, different key, reaches the model FENCED.
// See server/utils/coaching.js.
