...
.staged li { font-size: 12.5px; color: var(--rs-ink); background: var(--rs-panel-2); border: 1px solid var(--rs-line); border-radius: 7px; padding: 6px 10px; margin-top: 6px; display: flex; justify-content: space-between; gap: 10px; }
.staged .remove { color: var(--rs-crit); text-decoration: none; font-weight: 600; }
...
.confirm-table th { font-size: 10.5px; letter-spacing: .09em; text-transform: uppercase; color: var(--rs-muted); text-align: left; padding: 8px 10px; border-bottom: 1px solid var(--rs-line); white-space: nowrap; }
.confirm-table td { padding: 6px 8px; border-bottom: 1px solid var(--rs-bg); vertical-align: middle; min-width: 96px; }
.confirm-table td:first-child { min-width: 220px; }
.confirm-table tr.grp td { padding-top: 14px; font-weight: 600; font-size: 11px; letter-spacing: .08em; text-transform: uppercase; color: var(--rs-accent); border-bottom: 1px solid var(--rs-line); }
