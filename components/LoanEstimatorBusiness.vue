...
<style scoped>
/* Palette and card read the shared visual-standard tokens (ReportShell). The card frame +
   title now read the --rs-card-* tokens (Step 3, standardised to the 14px radius and
   12px/600/.1em title). Left literal on purpose: the field-label ink (#223a57, no token). */
