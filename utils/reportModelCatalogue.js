...
export const MODELS = [
  ...
  // The Business Performance Report (item 4.70): the client's own document, built from this
  // year's and last year's Balance Sheet and Profit and Loss. Its route is /dashboard-reports
  // because /business-performance-report was taken by the Working Capital Cycle long before.
  { name: 'Dashboard Reports', category: 'Cash Flow', summary: 'The Business Performance Report — the client\'s own document, from their accounts, with the health score and the cash drivers.', scope: 'Built from this year\'s and last year\'s annual exports. Industry benchmarks, the inventory reader and the monthly view follow as their own stages.', status: STATUS_READY, modelClass: CLASS_REPORT, route: '/dashboard-reports' },
  ...
  // Item 5.3. Mike's own planning workbook, BO Expectations.xlsx: one model with two steps on his
