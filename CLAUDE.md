...
#    Finds the NEWEST export by pattern. This line named one export by filename and
#    crashed; `masterExport` exists precisely to retire hardcoded names like that.
