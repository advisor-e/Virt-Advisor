# OpenAI "Streaming API responses" — verbatim, as read 2026-09-24

> **Source:** https://developers.openai.com/api/docs/guides/streaming-responses.md — the `.md` version OpenAI publishes of the page, downloaded 2026-09-24.
