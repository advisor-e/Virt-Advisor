# OpenAI "Create moderation (API reference)" — verbatim, as read 2026-09-24

> **Source:** https://developers.openai.com/api/reference/resources/moderations/methods/create.md — the `.md` version OpenAI publishes of the page, downloaded 2026-09-24.
