...
>
> **Measured 2026-09-11 at commit `b252e1e`.**

**Working code: 89,579 lines** across 441 files — blank lines and
comment lines stripped; tests, design documents, data, scripts and locale strings left out.

| Where | Files | Lines of code | Comment lines |
|---|---:|---:|---:|
| Screens and components (`components`) | 146 | 43,760 | 13,661 |
| The Restify backend (`server`) | 207 | 40,571 | 29,344 |
...
| **Total working code** | **441** | **89,579** | **46,287** |

| By kind | Files | Lines of code |
|---|---:|---:|
| JavaScript | 257 | 44,159 |
| Vue screens and components | 184 | 45,420 |

**Beside the code, and not counted in it:**

- **Comments and documentation** inside those same files: 46,287 lines. The JSDoc rule asks for the *why*, and this is what it costs.
- **Tests**: 509 files, 86,722 lines of test code.
