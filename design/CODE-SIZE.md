...
>
> **Measured 2026-09-21 at commit `784925e4`.**

**Working code: 108,265 lines** across 530 files — blank lines and
...
| **Total working code** | **530** | **108,265** | **56,154** |

| By kind | Files | Lines of code |
|---|---:|---:|
| JavaScript | 286 | 51,215 |
| Vue screens and components | 244 | 57,050 |

**Beside the code, and not counted in it:**

- **Comments and documentation** inside those same files: 56,154 lines. The JSDoc rule asks for the *why*, and this is what it costs.
- **Tests**: 580 files, 101,062 lines of test code.
