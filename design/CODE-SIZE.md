...
>
> **Measured 2026-09-17 at commit `005bf944`.**

**Working code: 104,254 lines** across 494 files — blank lines and
comment lines stripped; tests, design documents, data, scripts and locale strings left out.

| Where | Files | Lines of code | Comment lines |
|---|---:|---:|---:|
| Screens and components (`components`) | 164 | 50,942 | 16,205 |
| The Restify backend (`server`) | 233 | 47,322 | 34,963 |
| Pages (`pages`) | 43 | 2,287 | 1,214 |
...
| **Total working code** | **494** | **104,254** | **55,029** |

| By kind | Files | Lines of code |
|---|---:|---:|
| JavaScript | 285 | 51,006 |
| Vue screens and components | 209 | 53,248 |

**Beside the code, and not counted in it:**

- **Comments and documentation** inside those same files: 55,029 lines. The JSDoc rule asks for the *why*, and this is what it costs.
- **Tests**: 573 files, 100,225 lines of test code.
- **Locale strings**: 6,462 non-blank lines across the language files. Words on screens, not logic.
