...
>
> **Measured 2026-09-14 at commit `7a84fccd`.**

**Working code: 95,890 lines** across 461 files — blank lines and
comment lines stripped; tests, design documents, data, scripts and locale strings left out.

| Where | Files | Lines of code | Comment lines |
|---|---:|---:|---:|
| Screens and components (`components`) | 151 | 47,485 | 14,586 |
| The Restify backend (`server`) | 216 | 43,048 | 31,753 |
...
| **Total working code** | **461** | **95,890** | **49,771** |

| By kind | Files | Lines of code |
|---|---:|---:|
| JavaScript | 267 | 46,685 |
| Vue screens and components | 194 | 49,205 |

**Beside the code, and not counted in it:**

- **Comments and documentation** inside those same files: 49,771 lines. The JSDoc rule asks for the *why*, and this is what it costs.
- **Tests**: 532 files, 92,419 lines of test code.
