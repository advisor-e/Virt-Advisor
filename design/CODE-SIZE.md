...
>
> **Measured 2026-09-21 at commit `d31ac768`.**

**Working code: 110,023 lines** across 538 files — blank lines and
comment lines stripped; tests, design documents, data, scripts and locale strings left out.

| Where | Files | Lines of code | Comment lines |
|---|---:|---:|---:|
| Screens and components (`components`) | 203 | 55,670 | 17,307 |
| The Restify backend (`server`) | 236 | 48,098 | 35,704 |
...
| **Total working code** | **538** | **110,023** | **57,244** |

| By kind | Files | Lines of code |
|---|---:|---:|
| JavaScript | 290 | 51,929 |
| Vue screens and components | 248 | 58,094 |

**Beside the code, and not counted in it:**

- **Comments and documentation** inside those same files: 57,244 lines. The JSDoc rule asks for the *why*, and this is what it costs.
- **Tests**: 588 files, 102,668 lines of test code.
