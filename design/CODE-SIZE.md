...
>
> **Measured 2026-09-18 at commit `9ca63350`.**
...
|---|---:|---:|---:|
| Screens and components (`components`) | 165 | 51,093 | 16,293 |
...
| **Total working code** | **495** | **104,505** | **55,282** |
...
- **Comments and documentation** inside those same files: 55,282 lines. The JSDoc rule asks for the *why*, and this is what it costs.
