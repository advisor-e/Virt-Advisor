...
>
> **Measured 2026-09-18 at commit `54f45259`.**

**Working code: 104,553 lines** across 495 files — blank lines and
comment lines stripped; tests, design documents, data, scripts and locale strings left out.

| Where | Files | Lines of code | Comment lines |
|---|---:|---:|---:|
| Screens and components (`components`) | 165 | 51,162 | 16,292 |
| The Restify backend (`server`) | 233 | 47,337 | 34,987 |
| Pages (`pages`) | 43 | 2,351 | 1,254 |
...
| **Total working code** | **495** | **104,553** | **55,180** |

| By kind | Files | Lines of code |
|---|---:|---:|
| JavaScript | 285 | 51,021 |
| Vue screens and components | 210 | 53,532 |

**Beside the code, and not counted in it:**

- **Comments and documentation** inside those same files: 55,180 lines. The JSDoc rule asks for the *why*, and this is what it costs.
- **Tests**: 573 files, 100,261 lines of test code.
