...
- **Comments and documentation** inside those same files: 58,674 lines. The JSDoc rule asks for the *why*, and this is what it costs.
- **Tests**: 597 files, 104,782 lines of test code.
- **Locale strings**: 6,761 non-blank lines across the language files. Words on screens, not logic.
