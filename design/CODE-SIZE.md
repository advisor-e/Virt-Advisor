...
>
> **Measured 2026-09-21 at commit `30497cd7`.**

**Working code: 112,921 lines** across 552 files — blank lines and
comment lines stripped; tests, design documents, data, scripts and locale strings left out.

| Where | Files | Lines of code | Comment lines |
|---|---:|---:|---:|
| Screens and components (`components`) | 210 | 57,480 | 17,852 |
| The Restify backend (`server`) | 240 | 48,798 | 36,100 |
| Pages (`pages`) | 46 | 2,619 | 1,645 |
...
| **Total working code** | **552** | **112,921** | **58,580** |

| By kind | Files | Lines of code |
|---|---:|---:|
| JavaScript | 295 | 52,907 |
| Vue screens and components | 257 | 60,014 |

**Beside the code, and not counted in it:**

- **Comments and documentation** inside those same files: 58,580 lines. The JSDoc rule asks for the *why*, and this is what it costs.
- **Tests**: 596 files, 104,736 lines of test code.
