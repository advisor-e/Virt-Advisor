...
>
> **Measured 2026-09-10 at commit `90f6fe5`.**

**Working code: 85,309 lines** across 422 files — blank lines and
comment lines stripped; tests, design documents, data, scripts and locale strings left out.

| Where | Files | Lines of code | Comment lines |
|---|---:|---:|---:|
| Screens and components (`components`) | 141 | 42,229 | 13,017 |
| The Restify backend (`server`) | 194 | 37,853 | 27,524 |
...
| **Total working code** | **422** | **85,309** | **43,773** |

| By kind | Files | Lines of code |
|---|---:|---:|
| JavaScript | 243 | 41,420 |
| Vue screens and components | 179 | 43,889 |

**Beside the code, and not counted in it:**

- **Comments and documentation** inside those same files: 43,773 lines. The JSDoc rule asks for the *why*, and this is what it costs.
- **Tests**: 486 files, 81,256 lines of test code.
