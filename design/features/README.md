...
| [Business Entity Reports](business-entity-reports.md) — a client's own view of the reports, which models the advisor has opened to them, and how a client's edits are shown. **Part 1, the stub, is built; part 2 is item 4.62.** | — |
