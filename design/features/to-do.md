...
| 6 | **4.97** Wages/Salary Review - labour margin, and a register gated on due diligence ⚠ *not yet ranked by Mike* | 3 | — | **Mike** | **laptop**, since 2026-09-14 |
| 7 | **4.98** Startup reads the other machine's handover from the wrong branch ⚠ *not yet ranked by Mike* | 2 | — | Us | — |
