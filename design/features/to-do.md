...
| 8 | **7.9** Eight of nineteen calculators are not offered when the advisor asks the question they answer ⚠ *not yet ranked by Mike* | 4 | — | **Mike** | — |
...
**Eleven live items. Seven need Mike.** If this list passes about twenty, something is wrong.
<!-- END GENERATED -->
