...
| 9 | **15.16** An advisor teaches twenty topics and has nowhere to write the client answer down ⚠ *not yet ranked by Mike* | 4 | — | Us | — |
...
**Eighteen live items. Two need Mike.** If this list passes about twenty, something is wrong.
<!-- END GENERATED -->
