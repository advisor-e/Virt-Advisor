...
| --- | --- | --- | --- | --- | --- |
| 1 | **15.23** Business Targets can't reach the Owner Expectations model inside a session ⚠ *not yet ranked by Mike* | 3 | — | Us | **laptop**, since 2026-09-25 |
...
| 4 | **22.1** Test suites collide on a shared dev file and block pushes at random ⚠ *not yet ranked by Mike* | 2 | — | Us | — |
...
| 19 | **8.4** Meetings longer than about 27 minutes are too big for OpenAI and lose their audio ⚠ *not yet ranked by Mike* | 4 | — | Us | — |
...
**21 live items. Four need Mike.** If this list passes about twenty, something is wrong.
<!-- END GENERATED -->
