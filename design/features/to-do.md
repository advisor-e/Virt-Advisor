...
| 6 | **7.5** Nothing records which calculation model the AI named, so nobody can check its judgement ⚠ *not yet ranked by Mike* | 2 | — | Us | **laptop**, since 2026-09-16 |
| 7 | **7.6** The AI declares its model choice only sometimes, so declines under-count ⚠ *not yet ranked by Mike* | 2 | — | **Mike** | — |
| 8 | **7.12** The right calculator is offered only sometimes, and sometimes the wrong one is ⚠ *not yet ranked by Mike* | 4 | — | Us | — |
...
| 27 | **13.1** Changing currency relabels figures and does not convert them ⚠ *not yet ranked by Mike* | 4 | — | Us | — |
...
| 30 | **13.4** An advisor cannot set a currency for one client ⚠ *not yet ranked by Mike* | 3 | — | Us | — |
...
**33 live items. Thirteen need Mike.** If this list passes about twenty, something is wrong.
<!-- END GENERATED -->
