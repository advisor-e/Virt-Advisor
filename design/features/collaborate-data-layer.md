...
⚠ A former second open item — "the standalone app's own handover documents still describe a
separate application" — was wrong and is **withdrawn (2026-08-21)**: the documents it named have
never existed in this repository, and the documents the master team actually receives —
[`../UAT-LOAD-PACK.md`](../UAT-LOAD-PACK.md) and [`../HANDOFF.md`](../HANDOFF.md) — already
describe a section of this app, not a separate one.
