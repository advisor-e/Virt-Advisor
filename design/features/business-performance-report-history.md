...
| The Stats NZ files | DataInfo+ was found to publish metadata only; Mike pointed at `C:\Some VS Code\Perf Report`, where the two CSVs he had downloaded that morning sat — *"benchmark_ratios_all_industries and financial_all_industries-2025 should give you what you need"*. They did: 483 industries, 228 with benchmarks, the eight ratios by size band with quartiles, the bands' turnover ranges, counts and accuracy | 2026-09-08, Mike |
| Stage 3 built — the benchmarker | Reader, shipped 2025 release, store, routes, the finder and size bands on step 1, the comparison table on page 7; the client's ratios on Stats NZ's definitions (quick ratio and stock turnover differ from the workbook's). Five deviations in the Brief §4 (p–t) | 2026-09-08, built after his "yes" to the slice |
| The page cap | The fifteen applies to the BASE report, the closing page included; optional pages are the advisor's choice with no limit — the question the optional-pages drawing's memo left open. The toolbar count, the step 5 band and the pages hint lose the "of 15" | 2026-09-08, Mike: *"If an advisor selects the pages they want — then no limit need apply. The limit only applies to the 'base' report — inclusive of a disclaimer page — thereafter it's optional"* |
| The Industry Benchmarks tab | Drawn in the thresholds tab's style sheet, shown to Mike in the browser and as an artifact; the tab name and the button wording put to him as the two words to change | 2026-09-08, Mike, "yes" to *"Do you approve this drawing to build from, with those two words as drawn?"* — built the same hour |
| Stage 5 scoped | The drawing already showed the two quarterly charts and the bank line by month; found while scoping that page 9 is drawn as a THREE-year trend where the build printed two, unrecorded in the deviation list, and that the Brief's "five-year" was the workbook's five columns, not the drawing. Recommended: three years as drawn, the monthly view from a by-month Profit and Loss and a by-month Balance Sheet, the third year through the existing annual readers, and drawing the two screen changes before any code | 2026-09-08, Mike, "yes" to *"Shall I go ahead with the drawings?"* |
| Stage 5 drawn | Step 2 gains two optional groups, *By month, this year* and *The year before last*, below the four annual zones; page 15, *Sales Volatility*, added to the optional-pages drawing on the Volatility Report's own arithmetic and band words. Committed as `49bbc4a` and opened in Chrome (the VS Code links pointed at the stale E: copy) | 2026-09-08, Mike, *"they look great"* to *"Do the two drawings read right, so I can start building stage 5 from them?"* |
| Stage 5 built | The by-month readers, the monthly assembler and route, six annual files with the third year as `earlier`, the pages model's `monthlyView`, the three chart switches, the three-column trend table, the Sales Volatility page, the saved row. Three deviations in the Brief §4 (z–ab) | 2026-09-08, built after his yes |
