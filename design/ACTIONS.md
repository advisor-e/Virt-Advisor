...
- <a id="tree-fidelity"></a>☐ **P2 · DATA (needs Mike — provenance) — `get_positioning` carries JSON content NOT in its source PDF.** Found by the 2026-06-23 fidelity sweep (6 of 8 trees faithful). Full results: [`design/TREE-PDF-FIDELITY-SWEEP-2026-06-23.md`](TREE-PDF-FIDELITY-SWEEP-2026-06-23.md). **One open item:**
  ...
  - ✅ **`valuation` — RESOLVED 2026-06-24.** The sweep had only read `Valuation Logic.pdf`; the companion **`Valuation support.pdf`** is the real source (6-step methodology + 3-Point Sensitivities + the Sale Assessment "Models" family). The one element in no firm PDF — the **MBO/BIMBO/Newco** branch — was **ratified upstream by Mike** (updated the Indicative Value Questions template in Advisor-e). Branch stays as-is; the valuation soft-hint (`327f592`) rests on valid, sourced data. *Source:* full PDF re-read + Mike 2026-06-24.
