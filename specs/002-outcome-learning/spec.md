...
- **FR-008**: An adjustment MUST NOT be proposed as publishable until it meets a floor of contributing firms and cases; the floor and the current counts MUST be shown beside every adjustment. [NEEDS CLARIFICATION: the floor figures — proposed 5 firms and 30 cases, the meeting aggregate's 5-advisor / 20-meeting precedent scaled for cross-firm evidence; Mike sets the final numbers]
...
- **FR-010**: A live adjustment MUST apply as a score adjustment through the same mechanism as distinction boosts, and MUST be capped so that pooled evidence can never outrank what the advisor said in the current session. [NEEDS CLARIFICATION: direction — hold-back only (a template that keeps going less well ranks lower), or both directions (one that keeps going well may also rank higher); recommended hold-back only in the first release, so nothing pooled can ever push a template above the advisor's own evidence]
...
- The meeting aggregate's floor (5 advisors, 20 meetings) is the in-app precedent for evidence thresholds; the proposed 5 firms and 30 cases follow it and await Mike's ruling.
