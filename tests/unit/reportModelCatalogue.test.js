...
describe('report model catalogue', () => {
  ...
  describe('model class (design/MODEL-CLASSIFICATION.md)', () => {
    ...
    it('classes the built models correctly — 4 Education + 4 Report-class + 4 Decision-class builds', () => {
      ...
      // The High-Level Budget (4.88, built 2026-09-12) is the sixth Report-class build:
      ...
      // The Wages/Salary Review (4.100, built 2026-09-14) is the sixth Decision-class build,
